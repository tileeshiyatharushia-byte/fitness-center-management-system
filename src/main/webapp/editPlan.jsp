...
<html>
<head>
  <title>Edit Plan | IRON FORGE FITNESS</title>
  <!-- Bootstrap 5 CSS -->
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="MembershipPlanServlet?action=sortByRenewalDate"><i class="fas fa-list-alt me-1"></i> Plans</a>
        </li>
        <li class="nav-item">
  ...
  <div class="form-container">
    ...
    <form action="MembershipPlanServlet" method="post">
      ...
      <div class="mb-4">
        ...
        <input type="text" class="form-control" id="planId" name="planId" value="${param.planId}" readonly>
      </div>
      ...
      <div class="d-flex justify-content-between mt-5">
        <a href="viewPlans.jsp" class="btn btn-outline-gray px-4">
