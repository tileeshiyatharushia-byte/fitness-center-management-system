...
<head>
  ...
  <title>Edit Review | IRON FORGE FITNESS</title>
  <!-- Bootstrap 5 CSS -->
...
<%
  ...
  if (review == null) {
    response.sendRedirect("viewReviews.jsp?error=Review not found");
    return;
  }
%>
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="submitReview.jsp"><i class="fas fa-edit me-1"></i> Submit Review</a>
        </li>
        <li class="nav-item">
...
<div class="container">
  <div class="edit-review-container">
    <h2 class="text-center mb-4"><i class="fas fa-edit me-2"></i>EDIT REVIEW</h2>

    <div class="review-info">
      <div class="row mb-2">
        <div class="col-md-4">
          <span class="info-label">Member ID:</span> <%= review.getMemberId() %>
        </div>
<%--        <div class="col-md-4">--%>
<%--          <span class="info-label">Trainer ID:</span> <%= review.getTrainerId() != null ? review.getTrainerId() : "N/A" %>--%>
<%--        </div>--%>
<%--        <div class="col-md-4">--%>
<%--          <span class="info-label">Class ID:</span> <%= review.getClassId() != null ? review.getClassId() : "N/A" %>--%>
<%--        </div>--%>
      </div>
      <div class="row">
        <div class="col-md-6">
          <span class="info-label">Date:</span> <%= review.getReviewDate() %>
        </div>
        <div class="col-md-6">
          <span class="info-label">Current Rating:</span>
          <% for (int i = 1; i <= 5; i++) { %>
          <i class="fas fa-star<%= i > review.getRating() ? "-half-alt" : "" %> text-warning"></i>
          <% } %>
        </div>
      </div>
    </div>
    ...
    <form action="ReviewServlet" method="post">
      ...
      <div class="mb-4">
        ...
        <textarea class="form-control" id="comment" name="comment" rows="4" required><%= review.getComment() %></textarea>
      </div>
      ...
      <div class="d-grid gap-2">
        ...
        <a href="viewReviews.jsp" class="btn btn-outline-orange">
